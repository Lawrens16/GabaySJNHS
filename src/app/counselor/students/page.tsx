      ...
      <div className="flex flex-col sm:flex-row items-center gap-3">
        <div className="relative flex-1 w-full">
          ...
          <input
            ...
            className="w-full h-11 pl-10 pr-4 rounded-xl bg-slate-900 border border-slate-800 text-white placeholder-slate-500 text-xs focus:ring-2 focus:ring-blue-500 focus:outline-none transition"
          />
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {loading ? (
          ...
          <div className="col-span-full p-12 text-center text-slate-400 bg-slate-900/50 rounded-2xl border border-slate-800">
            ...
            <p className="text-xs text-slate-500 mt-1">There are no assigned students matching this filter.</p>
          </div>
        ) : (
              ...
              >
                <div>
                  ...
                  <div className="flex items-start justify-between gap-3 mb-3">
                    <div className="w-14 h-14 rounded-2xl bg-slate-800 border border-slate-700 overflow-hidden flex items-center justify-center shrink-0 shadow-md">
                      {student.photo_url ? (
                        <img
                        ...
                        <div className="w-full h-full flex flex-col items-center justify-center bg-amber-500/10 text-amber-400">
                ...
                <div className="mt-5 pt-3 border-t border-slate-800 flex items-center gap-2">
                  {isStub ? (
                    <Link
                      ...
                      className="w-full h-9 rounded-xl bg-amber-600 hover:bg-amber-500 text-slate-950 font-bold text-xs flex items-center justify-center gap-1.5 transition active:scale-95 shadow-md shadow-amber-600/20"
                    >
                    ...
                    <Link
                      ...
                      className="w-full h-9 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs font-semibold flex items-center justify-center gap-1 transition"
                    >
