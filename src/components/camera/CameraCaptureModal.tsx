      ...
      <div className="relative w-full max-w-lg bg-slate-900 border border-slate-800 rounded-3xl overflow-hidden shadow-2xl flex flex-col max-h-[90vh]">
        ...
        <div className="relative flex-1 bg-black flex items-center justify-center min-h-[320px] max-h-[460px] overflow-hidden">
            ...
            <>
              ...
              {mode === 'avatar' ? (
                ...
                <div className="absolute inset-0 pointer-events-none flex items-center justify-center">
                  <div className="w-52 h-64 sm:w-60 sm:h-72 border-2 border-dashed border-blue-400/80 rounded-[50%] shadow-[0_0_0_9999px_rgba(0,0,0,0.55)] flex items-center justify-center">
                    <div className="text-[11px] text-blue-200/90 bg-slate-900/80 px-2.5 py-1 rounded-full border border-blue-400/30">
                      Center Student Face
                    </div>
                  </div>
                </div>
                ...
                <div className="absolute inset-0 pointer-events-none flex items-center justify-center p-6">
                  <div className="w-full h-full max-w-sm max-h-80 border-2 border-amber-400/80 rounded-2xl shadow-[0_0_0_9999px_rgba(0,0,0,0.55)] flex flex-col justify-between p-3">
                    ...
                    <div className="self-center text-[11px] text-amber-200 bg-slate-900/80 px-3 py-1 rounded-full border border-amber-400/30">
              ...
              <button
                ...
                className="absolute top-4 right-4 w-10 h-10 rounded-full bg-slate-900/70 backdrop-blur border border-white/20 text-white flex items-center justify-center hover:bg-slate-800 transition active:scale-90 cursor-pointer"
                title="Switch Camera"
              >
          ...
          {cameraError && !capturedSnapshot && (
            <div className="absolute inset-x-4 bottom-4 p-3 rounded-xl bg-slate-900/90 border border-amber-500/30 text-amber-300 text-xs flex items-center gap-2">
        ...
        {compressionResult && (
          <div className="px-5 py-2.5 bg-slate-800/80 border-t border-slate-700/60 flex items-center justify-between text-xs text-slate-300 shrink-0">
            <div className="flex items-center gap-1.5 text-emerald-400 font-semibold">
              <Sparkles className="w-4 h-4" />
              <span>Optimized WebP</span>
            </div>
            <div className="text-slate-400">
              <span className="line-through text-slate-500">{compressionResult.originalSizeKB} KB</span>{' '}
              → <strong className="text-emerald-300 font-bold">{compressionResult.compressedSizeKB} KB</strong>{' '}
          ...
          {!capturedSnapshot ? (
            <>
              ...
              <button
                ...
                className="w-14 h-14 rounded-full bg-white hover:bg-slate-200 text-slate-900 shadow-xl shadow-white/20 flex items-center justify-center ring-4 ring-blue-500/30 transition active:scale-90 cursor-pointer"
              >
